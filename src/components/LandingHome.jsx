...
const LandingHome = () => {
  return (
    <section className="flex flex-col h-screen lg:flex-row">
      ...
      <div className="z-0 flex items-center justify-center w-full h-1/2 landingBlack lg:hover:contrast-125 lg:w-1/2 lg:h-full">
        <Link to="/home">
          <button
            type="button"
      ...
      <div className="z-0 flex items-center justify-center w-full h-1/2 landingWhite lg:hover:brightness-125 lg:w-1/2 lg:h-full">
        <Link to="/home">
          <button
            type="button"
