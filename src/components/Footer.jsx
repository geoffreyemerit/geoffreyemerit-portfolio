...
const Footer = () => {
  return (
    <footer className="flex flex-col p-4 bg-opacity-30 text-secondary bg-primary sm:flex-row sm:items-center dark:text-primary dark:bg-secondary dark:bg-opacity-30">
      {/* :FOOTER */}
      {/* >> Social Networks */}
